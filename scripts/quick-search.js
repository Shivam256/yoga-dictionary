...
const createAsanaCard = (asana) => {
  ...
  card.innerHTML = `${asana.english_name} <br> <span class="sanskrit-name">(${asana.sanskrit_name})</span> `;
  ...
  card.addEventListener("click", ()=>
  {
    ...
    asanaContainer.style.opacity = "0.5";
    ...
    asanaImageContainer.classList.add("col-5")
    asanaData.classList.add("asana-data");
    asanaData.classList.add("col-7");
